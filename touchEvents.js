...
const addOpenEventListeners = ele => {
    ele.addEventListener('touchstart', openStart)
    ele.addEventListener('touchmove', openMove)
    ele.addEventListener('touchend', openEnd)
}

// add event listeners to openDrawerElement
const removeOpenEventListeners = ele => {
    ele.removeEventListener('touchstart', openStart)
    ele.removeEventListener('touchmove', openMove)
    ele.removeEventListener('touchend', openEnd)
}
...
// add event listeners to openDrawerElement at startup 
addOpenEventListeners(openDrawerElement);